...
package com.tdj.zxinglibrary.camera;
...
import com.tdj.zxinglibrary.android.CaptureActivityHandler;
...
//    }
    ...
    public void openFlashLight(CaptureActivityHandler handler) {
...
//            msg.what = Constant.FLASH_CLOSE;
    ...
    public void closeFlashLight(CaptureActivityHandler handler) {
...
//                ImageUtil.binaryzationBitmap(pix, 180);
//
...
//
//
////                Bitmap new_data = ImageUtil.binaryzationBitmap(bitmap, 180);
////                if (new_data != null) {
////
////                    ByteArrayOutputStream baos = new ByteArrayOutputStream();
////                    new_data.compress(Bitmap.CompressFormat.PNG, 100, baos);
////
////                    byte[] arrs = baos.toByteArray();
////                    data = arrs;
////                }
//
//
