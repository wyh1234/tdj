...
public class NineImageView extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        int WIDTH = DensityUtil.getScreenWidthPixels(context) - DensityUtil.dp2px(15 * 2);
...
//        ImageLoaderUtils.loadImage(imageView, url, false);
        ...
        RequestOptions requestOptions = imageLoader.requestOptions(R.color.black_63).centerCrop().skipMemoryCache(false).diskCacheStrategy(DiskCacheStrategy.RESOURCE).override(Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL);
