...
//        UNSPECIFIED：表示子布局想要多大就多大，很少使用
    ...
    private Bitmap createBitmapValidate() {
        ...
        for (int i = 1; i <= length; i++) {
            ...
            //给画笔设置随机颜色
            mPaint.setARGB(255, mRandom.nextInt(180) + 20, mRandom.nextInt(180) + 20,
                    mRandom.nextInt(180) + 20);
            //设置字体的绘制位置
            canvas.drawText(String.valueOf(mCodeText.charAt(i - 1)), left + (i - 1) * charLength,
                    mHeight * 4 / 5f, mPaint);
