...
public class MyRadioGroup extends LinearLayout {
    ...
    private HashMap<String, RadioButton> radioButtonList = new LinkedHashMap<>();
    ...
    public Object getCheckedTag() {
        return ViewUtils.findViewById(this, getCheckedRadioButtonId()).getTag();
    }

    public void setCheckedByTag(Object tag) {
        check(radioButtonList.get(tag.toString()).getId());
    }
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RadioButton) {
            ...
            if (button.getTag() != null) radioButtonList.put(button.getTag().toString(), button);
            if (button.isChecked()) {
                mProtectFromCheckedChange = true;
                if (mCheckedId != -1) {
     ...
     * </p>
     *
     * @param id the unique id of the radio button to in this groupname
     ...
     * <p>
     * <p/>
     * Returns the identifier of the ed radio button in this groupname. Upon
     * <p/>
     * empty ion, the returned value is -1.
     * <p/>
     * </p>
     *
     * @return the unique id of the ed radio button in this groupname
     * @see ＃check(int)
     * @see ＃clearCheck()
     */
     ...
     * <p/>
     * this groupname is ed and {@link ＃getCheckedRadioButtonId()} returns
     * <p/>
     * null.
     * <p/>
     * </p>
     ...
     * <p/>
     * button changed in this groupname.
     * <p/>
     * </p>
     */
    public interface OnCheckedChangeListener {
         ...
         * </p>
         *
         * @param group     the groupname in which the checked radio button has changed
