...
public final class TopSnackBar extends BaseTransientTopBar<TopSnackBar> {
    ...
    public static TopSnackBar make(@NonNull View view, @NonNull CharSequence text, @Duration int duration) {
        ...
        final SnackbarContentLayout content = (SnackbarContentLayout) inflater.inflate(R.layout.design_layout_top_snackbar_include, parent, false);
    ...
    public void setSnackbarMessageTextColor(@ColorRes int color) {
       // mView.setBackgroundColor(UIUtils.getColor(R.color.translucent));
        ((TextView) mView.findViewById(R.id.snackbar_text)).setTextColor(UIUtils.getColor(color));
    }
