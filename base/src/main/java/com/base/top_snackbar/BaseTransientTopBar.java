...
import static com.base.top_snackbar.AnimationUtils.DEFULT_interpolator;
...
public abstract class BaseTransientTopBar<B extends BaseTransientTopBar<B>> {
     ...
     * @see BaseTransientTopBar#addCallback(BaseTransientTopBar.BaseCallback)
     */
    public abstract static class BaseCallback<B> {
         ...
         */
        public void onDismissed(B transientBottomBar, @BaseTransientTopBar.BaseCallback.DismissEvent int event) {
            // empty
        }
    ...
    final BaseTransientTopBar.SnackbarBaseLayout mView;
    private final BaseTransientTopBar.ContentViewCallback mContentViewCallback;
     ...
     */
    @NonNull
    public B addCallback(@NonNull BaseTransientTopBar.BaseCallback<B> callback) {
        if (callback == null) {
            return (B) this;
        }
        if (mCallbacks == null) {
    ...
    void animateViewIn() {
        if (Build.VERSION.SDK_INT >= 12) {
         ...
         //   animator.setInterpolator(DEFULT_interpolator);
            ...
            anim.setInterpolator(DEFULT_interpolator);
