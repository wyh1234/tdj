...
class EyesKitKat {
    ...
    static void setStatusBarColor(Activity activity, int statusColor) {
        ...
        LogUtils.i(statusColor== UIUtils.getColor(activity, R.color.white));
        if (statusColor== UIUtils.getColor(activity, R.color.white)||statusColor== UIUtils.getColor(activity, R.color.red_f0)){
            Eyes.setLightStatusBar(activity,statusColor== UIUtils.getColor(activity, R.color.white));
