...
public abstract class TakePhotosDataActivity extends DataBaseActivity implements TakePhoto.TakeResultListener, InvokeListener {
    private static final String TAG = TakePhotosDataActivity.class.getName();
