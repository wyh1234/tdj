...
public class ZoomImageView extends GlideImageView implements OnScaleGestureListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private boolean isLongPressSave = true;//是否长按保存？
    ...
    public void setLongPressSave(boolean longPressSave) {
        isLongPressSave = longPressSave;
    }
...
/*
            ...
            public void onLongPress(MotionEvent e) {
                if (isLongPressSave) {
                    AlertDialog.Builder builder = ViewUtils.showDialog(getContext(), "提示", "保存图片");
                    builder.setPositiveButton("保存", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ImageLoaderUtils.saveImage(imageUrl);
                            dialog.dismiss();
                        }
                    });
    ...
    protected void onAttachedToWindow() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(ZoomImageView.this);
    }
