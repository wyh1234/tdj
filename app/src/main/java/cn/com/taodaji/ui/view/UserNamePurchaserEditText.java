...
public class UserNamePurchaserEditText extends MyEditText implements DrawableRightListener, TextWatcher ,DrawableLeftListener {
    public UserNameChangeListener userNameChangeListener;

    public UserNamePurchaserEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init_view();
    }

    public UserNamePurchaserEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init_view();
    }

    public UserNamePurchaserEditText(Context context) {
        super(context);
        init_view();
    }

    public UserNamePurchaserEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
