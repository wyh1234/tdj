...
public class PasswordSupplyEditText extends MyEditText implements DrawableLeftListener {
    public PasswordSupplyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init_view();
    }

    public PasswordSupplyEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init_view();
    }

    public PasswordSupplyEditText(Context context) {
        super(context);
        init_view();
    }

    public PasswordSupplyEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
