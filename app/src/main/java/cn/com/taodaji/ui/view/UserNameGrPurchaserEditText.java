...
public class UserNameGrPurchaserEditText extends MyEditText implements DrawableRightListener, TextWatcher, DrawableLeftListener {
    public UserNameChangeListener userNameChangeListener;

    public UserNameGrPurchaserEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init_view();
    }

    public UserNameGrPurchaserEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init_view();
    }

    public UserNameGrPurchaserEditText(Context context) {
        super(context);
        init_view();
    }

    public UserNameGrPurchaserEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
