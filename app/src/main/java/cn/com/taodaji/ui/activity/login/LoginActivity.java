...
public class LoginActivity extends DataBaseActivity implements View.OnClickListener, Constants , UserNameChangeListener {
    ...
    private TextView forget_password,tv_fw,tv_ys;
    private Button login_button;
    private TextView login_type;
    private TextView register;
    private TextView get_verificationCode;
    private boolean phone_input = false;
    private GlideImageView login_close,back;

    @Override
    protected View getContentLayout() {
        return getLayoutView(R.layout.activity_login);
    }

    protected void initView() {
        super.initView();
        //setStatusBarForeColorColor(true);
    ...
    private void loginFlagSwitch(String login_flag) {
        ...
        switch (login_flag) {
            ...
            case PURCHASER://采购商
                ...
                login_button.setBackgroundResource(R.drawable.r_round_rect_solid_orange_ff7d01);
    ...
    private void loginModeSwitch(String type) {
        switch (type) {
            case VER_CODE_LOGIN:
                ...
                password_edit.setCompoundDrawables(null, null, null, null);
            ...
            case PASSWORD_LOGIN:
                ...
                Drawable drawable1 = BitmapUtil.getDrawable(R.mipmap.suo_bg);
                // 这一步必须要做,否则不会显示.
                drawable1.setBounds(0, 0, drawable1.getMinimumWidth(), drawable1.getMinimumHeight());
                password_edit.setCompoundDrawables(drawable1, null, null, null);
