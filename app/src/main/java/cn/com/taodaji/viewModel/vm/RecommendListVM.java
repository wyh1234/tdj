...
public class RecommendListVM extends BaseVM {
    ...
    public  RecommendListVM(boolean b){
        this.b=b;
...
//        putRelation(R.id.goods_content, "description");
        ...
        putRelation_more("name","productType");
    ...
    public <T> void setValue(BaseViewHolder viewHolder, String pamstr, @NonNull T bean) {
        ...
        switch (pamstr) {
            ...
            case "name":
                ...
                if (b){
                    sb= SimpleStringUtils.getTitleNames(dataBean.getName(),"",dataBean.getProductType(),0,dataBean.getIsP());

                }else {
                    sb=SimpleStringUtils.getTitleName(dataBean.getName(),"",dataBean.getProductType(),0,dataBean.getIsP());
