    ...
    private void tryNewMiuiBadge(Context context, int badgeCount) throws ShortcutBadgeException {
        ...
        if (resolveInfo != null) {
            ...
            Notification.Builder builder = new Notification.Builder(context)
                    .setContentTitle("未读消息通知")
                    .setContentText("淘大集有重要消息未读")
                    .setSmallIcon(context.getApplicationInfo().icon);//resolveInfo.getIconResource()

            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.addCategory(Intent.CATEGORY_LAUNCHER);
            ComponentName cn = new ComponentName("cn.com.taodaji", "StartActivity");
